...
This document provides information about contributing code to the Git Forensics Jenkins plug-in. 
...
3. Select `git-forensics-plugin` as **base fork** and `master` as **base**, then click **Create Pull Request**.
...
The CI job for this project is located at [ci.jenkins.io](https://ci.jenkins.io/job/Plugins/job/git-forensics-plugin/).
